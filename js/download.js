window.onload = function changeDownloadLinks() {
    ...
    fetch("https://api.github.com/repos/tahoma2d/tahoma2d/releases/tags/nightly")
        ...
        .then(data => {
            ...
            nightlyWindowsLink.href = data.assets[4].browser_download_url
            nightlyMacLink.href = data.assets[3].browser_download_url
            nightlyLinuxLink.href = data.assets[1].browser_download_url
        })
